...
try {
    ...
    $db->query('DROP TRIGGER IF EXISTS tr_lands_next_harvest_insert');
    $db->query('DROP TRIGGER IF EXISTS tr_lands_next_harvest_update');
    ...
    if ($count == 0) {
        ...
        foreach ($sampleLands as $land) {
            $sql = "INSERT INTO lands (
                        ...
                        plant_date, harvest_cycle_days, next_harvest_date, geometry, size, 
