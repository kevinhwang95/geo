<?php
/**
 * Enhanced PhotoController with proper URL construction
 * This version includes environment-based domain configuration
 */
...
class EnhancedPhotoController
{
    ...
    public function __construct()
    {
        ...
        // Get base URL from environment or construct from current request
    ...
    public function getPhoto($id)
    {
        ...
        $photo['url'] = $this->baseUrl . '/uploads/photos/' . $photo['filename'];
        $photo['camera_info'] = json_decode($photo['camera_info'], true);

        // Debug logging
        error_log("Photo URL generated: " . $photo['url']);
        error_log("Base URL used: " . $this->baseUrl);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $photoUrl = $this->baseUrl . '/uploads/photos/' . $filename;
            
            // Debug logging
            error_log("Upload response URL: " . $photoUrl);
            error_log("Base URL used: " . $this->baseUrl);
...
if (basename(__FILE__) === basename($_SERVER['SCRIPT_NAME'])) {
    echo json_encode([
        'message' => 'Enhanced PhotoController loaded',
        'base_url' => (new EnhancedPhotoController())->getBaseUrl(),
