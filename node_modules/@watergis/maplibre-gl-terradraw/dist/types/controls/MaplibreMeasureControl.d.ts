...
import type { AreaUnit, DistanceUnit, forceAreaUnitType, forceDistanceUnitType, MeasureControlOptions } from '../interfaces';
...
export declare class MaplibreMeasureControl extends MaplibreTerradrawControl {
    ...
    get forceDistanceUnit(): forceDistanceUnitType;
    ...
    get forceAreaUnit(): forceAreaUnitType;
